function appelSupprimeAnimal(id_animal) {

    if (confirm("Voulez-vous supprimer l'animal ?") === true) {
        if (typeof id_animal !== 'undefined') {
            ...
            //alert(id_produit);   
            console.log("supprime_produit" + id_animal);
            xhr.open("GET", "../ajax/a_suppression_animal.php?variable1=" + id_animal, true);
            xhr.send(null);
        }
    }
}
